...
export default class Creador2 extends Component{
    ...
    crearReceta=()=>{
        ...
        if(this.state.titulo && this.state.plato && this.state.preparation && 
            ...
            || this.state.ing5 || this.state.ing6 || this.state.ing7 || this.state.ing8)){
                ...
                firebase.ref('/Recetario/Alimentos/'+nombre).set({
                    Titulo: this.state.titulo,
                    Color: color,
                    Imagen: this.state.infoPlato,
                    Ingredientes:{
            ...
            <ImageBackground source={require('../assets/fondoCocteles.png')} style={styles.fondo1}>
                <ScrollView> 
                    ...
                    <View style={{flex: 1,paddingTop:100, alignItems: 'flex-start'}}>
                        ...
                        <TouchableOpacity style={{padding: 5, backgroundColor: 'white',left:10, top: 10,paddingRight: 5,borderWidth:2}} onPress={()=>this.setState({plato:'Fruta y verdura',infoPlato: 1})}>
                            <Image source={require('../assets/ensalada.png')} style={{padding: 10, width:80,height:70,}}/>
                        </TouchableOpacity>
                        <TouchableOpacity style={{padding: 5, backgroundColor: 'white',left:10, top: 10,paddingRight: 5,borderWidth:2}} onPress={()=>this.setState({plato:'Cereal',infoPlato: 2})}>
                            <Image source={require('../assets/cereales.png')} style={{padding: 10, width:80,height:80,}}/>
                        </TouchableOpacity>
                        <TouchableOpacity style={{padding: 5, backgroundColor: 'white',left:10, top: 10,paddingRight: 25,borderWidth:2}} onPress={()=>this.setState({plato:'Leguminosa',infoPlato: 3})}>
                            <Image source={require('../assets/frijol.png')} style={{padding: 10, width:60,height:80,}}/>
                        </TouchableOpacity>
                        <TouchableOpacity style={{padding: 5, backgroundColor: 'white',left:10, top: 10,paddingRight: 5,borderWidth:2}} onPress={()=>this.setState({plato:'Origen animal',infoPlato: 4})}>
                            <Image source={require('../assets/carne.png')} style={{padding: 10, width:80,height:80,}}/>
                        </TouchableOpacity>
                        <TouchableOpacity style={{padding: 5, backgroundColor: 'white',left:10, top: 10,paddingRight: 25,borderWidth:2}} onPress={()=>this.setState({plato:'Reposteria',infoPlato: 5})}>
                            <Image source={require('../assets/postre.png')} style={{padding: 10, width:60,height:80,}}/>
                        </TouchableOpacity>
